import { processSteps } from "../../data/assetDetailData";

export default function ListingProcessSection() {
    return (
        <section className="bg-[#F8F8F8] px-4 py-16">
            <div className="mx-auto max-w-5xl">
                ...
                {processSteps.map((step) => (
                    ...
                    <div className="text-5xl font-semibold leading-none text-black">{step.number}</div>
