import { reviewCards } from "../../data/assetDetailData";
import ReviewArt from "../common/ReviewArt";

export default function ReviewPrioritizationSection() {
    return (
